...
CREATE TABLE `auth_info`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 14 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '权限信息表' ROW_FORMAT = Compact;
...
INSERT INTO `auth_info` VALUES (12, 'DB_DATASOURCE_MANAGE', '数据源管理权', 0, 1, '2019-06-29 13:01:20', 1);
...
CREATE TABLE `user_auth`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 48 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '用户权限表' ROW_FORMAT = Compact;
...
INSERT INTO `user_info` VALUES (2, '1', 'e10adc3949ba59abbe56e057f20f883e', '1111', NULL, NULL, 0, '2018-12-15 20:16:10', 1, '2018-12-15 20:19:50', NULL, 0);
INSERT INTO `user_info` VALUES (3, 'admin', 'bcb41ccdc4363c6848a1d760f26c28a0', 'admin', NULL, NULL, 0, '2019-06-21 15:19:40', 1, NULL, NULL, 0);
...
INSERT INTO `wiki_page_zan` VALUES (2, 3, NULL, 1, '暮光：城中城', '2019-04-02 15:09:01', 0);
INSERT INTO `wiki_page_zan` VALUES (3, 2, NULL, 1, '暮光：城中城', '2019-06-05 12:50:59', 0);
INSERT INTO `wiki_page_zan` VALUES (4, 5, NULL, 1, '暮光：城中城', '2019-06-12 12:18:27', 1);
...
) ENGINE = InnoDB AUTO_INCREMENT = 55 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '存储网页上相关的数据' ROW_FORMAT = Compact;
