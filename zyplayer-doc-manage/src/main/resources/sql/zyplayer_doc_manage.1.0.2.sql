...
CREATE TABLE `auth_info`  (
  ...
  `auth_type` tinyint(4) NOT NULL DEFAULT 0 COMMENT '权限类型 0=可使用 1=隐藏权限',
  PRIMARY KEY (`id`) USING BTREE
...
INSERT INTO `auth_info` VALUES (5, 'WIKI_CREATE_PAGE_', '创建wiki文档', 0, 1, '2019-06-04 13:01:20', 0);
INSERT INTO `auth_info` VALUES (6, 'WIKI_EDIT_PAGE_', '编辑wiki文档', 0, 1, '2019-06-04 13:01:20', 0);
...
CREATE TABLE `user_auth`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 38 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '用户权限表' ROW_FORMAT = Compact;
...
INSERT INTO `user_auth` VALUES (34, 1, 3, 1, 1, 0, '2019-06-29 22:48:27', '2019-06-29 22:50:27', NULL);
INSERT INTO `user_auth` VALUES (35, 1, 4, 1, 1, 0, '2019-06-29 22:48:27', '2019-06-29 22:50:27', NULL);
INSERT INTO `user_auth` VALUES (36, 1, 1, 1, NULL, 0, '2019-06-29 22:50:27', NULL, NULL);
INSERT INTO `user_auth` VALUES (37, 1, 2, 1, NULL, 0, '2019-06-29 22:50:27', NULL, NULL);
...
-- ----------------------------
INSERT INTO `user_info` VALUES (1, 'zyplayer', 'e10adc3949ba59abbe56e057f20f883e', '暮光：城中城', '806783409@qq.com', NULL, 0, '2018-12-01 11:37:39', NULL, '2019-06-29 21:14:40', '111', 1);
INSERT INTO `user_info` VALUES (2, '1', 'e10adc3949ba59abbe56e057f20f883e', '1111', '123456%@qq.com', NULL, 1, '2018-12-15 20:16:10', 1, '2019-06-28 23:06:50', '11', 1);
INSERT INTO `user_info` VALUES (3, '2', NULL, '2', '2', NULL, 0, '2019-06-28 22:47:23', 1, '2019-06-28 23:07:05', '2', 1);
INSERT INTO `user_info` VALUES (4, '3', 'e8d85c0dd850ed88537ffd5737bf9a33', '3', '3', NULL, 2, '2019-06-28 22:48:14', 1, '2019-06-29 22:08:23', '3', 1);
INSERT INTO `user_info` VALUES (6, '4', NULL, '4', NULL, NULL, 2, '2019-06-29 21:41:51', 1, NULL, NULL, 0);
...
-- ----------------------------
INSERT INTO `wiki_page` VALUES (1, 1, '关于zyplayer-doc工具', 0, 0, 0, 0, 1, '暮光：城中城', '2019-03-09 14:24:30', 1, '暮光：城中城', '2019-03-09 14:24:30', 0, 2, 1);
INSERT INTO `wiki_page` VALUES (2, 1, '开发规划', 0, 0, 0, 0, 1, '暮光：城中城', '2019-03-09 14:24:30', 1, '暮光：城中城', '2019-06-02 11:16:16', 0, 1, 2);
INSERT INTO `wiki_page` VALUES (3, 1, '升级日志', 0, 0, 0, 0, 1, '暮光：城中城', '2019-03-09 14:24:30', 1, '暮光：城中城', '2019-03-09 14:24:30', 0, 0, 3);
INSERT INTO `wiki_page` VALUES (4, 1, '贡献人员列表', 0, 0, 0, 0, 1, '暮光：城中城', '2019-03-09 14:24:30', 1, '暮光：城中城', '2019-04-21 17:07:29', 0, 0, 4);
INSERT INTO `wiki_page` VALUES (5, 1, 'zyplayer-doc-swagger', 0, 0, 0, 0, 1, '暮光：城中城', '2019-03-09 14:24:30', NULL, NULL, NULL, 0, 0, 5);
INSERT INTO `wiki_page` VALUES (6, 1, '如何使用', 5, 0, 0, 0, 1, '暮光：城中城', '2019-03-09 14:24:30', 1, '暮光：城中城', '2019-03-09 14:24:30', 0, 0, 6);
INSERT INTO `wiki_page` VALUES (7, 2, '所有格式测试', 0, 0, 0, 0, 1, '暮光：城中城', '2019-03-09 14:24:30', 1, '暮光：城中城', '2019-03-09 14:24:30', 0, 0, 7);
...
-- ----------------------------
INSERT INTO `wiki_page_comment` VALUES (1, 2, NULL, 'xxxx', 0, 1, '暮光：城中城', '2019-05-30 22:39:41', 0);
...
CREATE TABLE `wiki_page_content`  (
  ...
  `update_user_name` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '修改人名字',
  `update_time` datetime(0) NULL DEFAULT NULL COMMENT '修改时间',
  `preview` varchar(1024) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '预览内容',
  PRIMARY KEY (`id`) USING BTREE,
...
INSERT INTO `wiki_page_zan` VALUES (2, 2, NULL, 1, '暮光：城中城', '2019-05-30 22:40:23', 0);
...
) ENGINE = InnoDB AUTO_INCREMENT = 51 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '存储网页上相关的数据' ROW_FORMAT = Compact;
